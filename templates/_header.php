...
?>
<header>
<nav class=" z-10 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="flex flex-col items-center ml-3 static">
            ...
            <div class="absolute right-0 mt-10 z-10 hidden  text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-profile">
              ...
              <ul class="py-1" role="none">
                ...
                <li>
                  <a href="<?=  Router::generate("app_logout") ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Earnings</a>
                </li>
                <li>
